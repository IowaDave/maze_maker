 ...
 *																*
 * Adds to v3: portals on all 4 sides of maze					*
 *																*
		...
		for (col = 0; col < COLS; col++) {
			...
			// locate the corners of the cell
				...
				if (mazeCell[col][row] & PORTAL_TOP) {
					printf("\t\t\t<!-- shaded rect to fill the cell -->\n");
					printf("\t\t\t<rect class=\"pRect\" ");
					printf("x=\"%f\" y=\"%f\" ", cornerLeft+lineLength/5, cornerTop+lineLength/5);
					printf("width=\"%f\" height=\"%f\" />\n", lineLength*0.6, lineLength*0.6);
					/*
